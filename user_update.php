        ...
        <div class="container">
            <fieldset>
                ...
                <div class="mid">
                    ...
                    <input type="text" placeholder="Enter Name" name="name" id="name" required value="<?php echo htmlspecialchars($userData['name']); ?>"> <br><br>           
                    <label for="email"><b>Email</b></label><br>
                    <input type="email" placeholder="Enter Email" name="email" id="email" required value="<?php echo htmlspecialchars($userData['email']); ?>"><br><br> 
