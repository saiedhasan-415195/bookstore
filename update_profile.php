        ...
        <div class="container">
            <fieldset>
                ...
                <div class="mid">
                    ...
                    <input type="text" placeholder="Enter Name" name="name" id="name" required value="<?php echo htmlspecialchars($adminData['name']); ?>"> <br><br>           
                    <label for="email"><b>Email</b></label><br>
                    <input type="email" placeholder="Enter Email" name="email" id="email" required value="<?php echo htmlspecialchars($adminData['email']); ?>"><br><br> 
                    <label for="old_password"><b>Old Password</b></label><br>
                    <input type="password" placeholder="Enter Old Password" name="old_password" id="old_password" required><br><br> 
                    ...
                    <input type="password" placeholder="Repeat New Password" name="confirm_password" id="confirm_password" required><br><br>
                    <hr>
                </div>
                <div class="btn-div">
